-- =====================================================
-- DATOS ÚNICOS FINAL - INSTITUTO POLANCO
-- =====================================================
-- Script SQL con UUIDs dinámicos únicos garantizados
...
DECLARE
    ...
    counter INTEGER := 1;
BEGIN
    FOR student_record IN SELECT id, first_name, last_name FROM students LIMIT 5 LOOP
...
-- MENSAJE DE ÉXITO
-- =====================================================
SELECT 'DATOS ÚNICOS INSERTADOS EXITOSAMENTE - INSTITUTO POLANCO (FINAL)' as mensaje;
